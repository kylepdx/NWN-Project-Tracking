	                    ...
	                    if ( $.fn.dataTable.isDataTable( '#sg-search-table' ) ) {
							    ...
							    sgSearchTable = $('#sg-search-table').dataTable({
									...
									columns: [
										...
										{"data": "Title"},
										{"data": "Author.Title"},
										{"data": "SAP_x0020_Project_x0020_Number"}									
									],
									fnDrawCallback: function() {
	...
	NWF$.ajax({
               ...
               success: function (data) {
                    if (data.d) {
                    	...
                    	NWF$('#' + txtSAPProjectNumber).val(data.d.SAP_x0020_Project_x0020_Number);                    	
                    	NWF$('#' + mlotProjectDescription).val(data.d.Project_x0020_Description);
                    	...
                    	if (typeof data.d.Executive_x0020_Sponsors.results !== "undefined" && data.d.Executive_x0020_Sponsors.results.length > 0) {
                    		data.d.Executive_x0020_Sponsors.results.forEach(function(result) {
                    			if (result) {                    	
			                    	//execSponsor.search('nng\\' + result.UserName).done(function(data) {
			                    	execSponsor.search(result.Title).done(function(data) {
			                    		execSponsor.add(data[0]); 
                    	...
                    	if (typeof data.d.Project_x0020_Sponsors.results !== "undefined" && data.d.Project_x0020_Sponsors.results.length > 0) {
	                   		data.d.Project_x0020_Sponsors.results.forEach(function(result) {
                    			if (result) {                    	
			                    	//projSponsor.search('nng\\' + result.UserName).done(function(data) {
			                    	projSponsor.search(result.Title).done(function(data) {
			                    		projSponsor.add(data[0]); 
                    	...
                    	//if (data.d.Project_x0020_Manager.UserName) {
						if (typeof data.d.Project_x0020_Manager !== "undefined" && data.d.Project_x0020_Manager.UserName) {                    	
	                    	projManager.clear(); //remove existing data first
	                    	//projManager.search('nng\\' + data.d.Project_x0020_Manager.UserName).done(function(data) {
	                    	projManager.search(data.d.Project_x0020_Manager.Title).done(function(data) {
                    	...
                    	if (typeof data.d.Other_x0020_Signators.results !== "undefined" && data.d.Other_x0020_Signators.results.length > 0) {                    	
                    		data.d.Other_x0020_Signators.results.forEach(function(result) {
								if (result) {
			                    	//otherSignators.search('nng\\' + result.UserName).done(function(data) {
